...
function Footer() {
  return (
    <footer className="bg-gray-900 text-white text-gray-300 mt-10">
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-2 md:grid-cols-4 gap-8">
        <div>
          ...
          <ul className="space-y-3">
            ...
            <li><Link to="/" className="hover:text-blue-400 transition-colors">Programming</Link></li>
            <li><Link to="/" className="hover:text-blue-400 transition-colors">Design</Link></li>
            <li><Link to="/" className="hover:text-blue-400 transition-colors">Productivity</Link></li>
          </ul>
        </div>
        <div>
        ...
        <div>
          ...
          <ul className="space-y-3">
            ...
            <li><Link to="/" className="hover:text-blue-400 transition-colors">Feedback</Link></li>
          </ul>
        </div>
        <div>
      ...
      <div className="bg-gray-900 text-white py-4 text-center text-gray-400 text-sm">
